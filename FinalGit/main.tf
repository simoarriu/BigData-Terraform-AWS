...
resource "aws_s3_bucket" "bucketbigdataemrsimoo" {
  bucket = "bucketbigdataemrsimoo"
...
resource "aws_athena_database" "hoge" {
  name   = "users"
  bucket = aws_s3_bucket.bucketbigdataemrsimoo.bucket
}
...
resource "aws_glue_crawler" "product_crawler" {
  ...
  s3_target {
    path = "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files"
  }
}
...
resource "aws_glue_catalog_table" "table_movies" {
  ...
  table_type    = "EXTERNAL_TABLE"
    owner = "owner"
    storage_descriptor {
        location        = "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/movie"
...
resource "aws_glue_catalog_table" "table_ratings" {
  ...
  table_type    = "EXTERNAL_TABLE"
    owner = "owner"
    storage_descriptor {
        location        = "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/ratings"
        input_format    = "org.apache.hadoop.mapred.TextInputFormat"
        output_format   = "org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat"
        compressed  = "false"
        number_of_buckets = -1    
...
resource "aws_emr_cluster" "emr-spark-cluster" {
 ...
 EOF
   ...
   log_uri = "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}"
  ...
  step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        args = ["aws", "s3", "cp", "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/main.py", "/home/hadoop/datasetS3/" ]
      }
    }
  ...
  step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        args = ["aws", "s3", "cp", "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/methods.py", "/home/hadoop/datasetS3" ]
      }
    }
  ...
  step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        args = ["aws", "s3", "cp", "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/baseline.py", "/home/hadoop/datasetS3/" ]
      }
    }
  ...
  step {
      ...
      hadoop_jar_step {
        ...
        jar  = "command-runner.jar"
        args = ["spark-submit", "--deploy-mode", "client", "--master", "yarn" ,"--num-executors", "7", "--conf", "spark.dynamicAllocation.enabled=false","--py-files", "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/zippo.zip", "/home/hadoop/datasetS3/main.py", "28"]
  ...
  step {
      ...
      hadoop_jar_step {
        ...
        jar  = "command-runner.jar"
        args = ["spark-submit", "--deploy-mode", "client", "--master", "yarn" ,"--num-executors", "7", "--conf", "spark.dynamicAllocation.enabled=false","s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/baseline.py", "28"]
  ...
  step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        args = ["aws", "s3", "cp", "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/movies.csv", "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/movie/"]
      }
    }
...
step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        args = ["aws", "s3", "cp", "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/ratings.csv", "s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/ratings/" ]
      }
    }
...
step {
      ...
      hadoop_jar_step {
        ...
        args = ["aws", "athena", "start-query-execution", "--query-string", "${aws_athena_named_query.one.query}", "--query-execution-context", "Database=${aws_athena_database.hoge.name}", "--result-configuration", "OutputLocation=s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/movie/" ]
      }
    }
step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        #aws athena start-query-execution --query-string "select * from tbl01;" --result-configuration "OutputLocation=s3://ruan-athena-bucket/output/"     
        args = ["aws", "athena", "start-query-execution", "--query-string", "${aws_athena_named_query.two.query}", "--query-execution-context", "Database=${aws_athena_database.hoge.name}", "--result-configuration", "OutputLocation=s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/movie/" ]
      }
    }
step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        #aws athena start-query-execution --query-string "select * from tbl01;" --result-configuration "OutputLocation=s3://ruan-athena-bucket/output/"     
        args = ["aws", "athena", "start-query-execution", "--query-string", "${aws_athena_named_query.three.query}", "--query-execution-context", "Database=${aws_athena_database.hoge.name}", "--result-configuration", "OutputLocation=s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/movie/" ]
      }
    }
step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        #aws athena start-query-execution --query-string "select * from tbl01;" --result-configuration "OutputLocation=s3://ruan-athena-bucket/output/"     
        args = ["aws", "athena", "start-query-execution", "--query-string", "${aws_athena_named_query.four.query}", "--query-execution-context", "Database=${aws_athena_database.hoge.name}", "--result-configuration", "OutputLocation=s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/movie/" ]
      }
    }
step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        #aws athena start-query-execution --query-string "select * from tbl01;" --result-configuration "OutputLocation=s3://ruan-athena-bucket/output/"     
        args = ["aws", "athena", "start-query-execution", "--query-string", "${aws_athena_named_query.five.query}", "--query-execution-context", "Database=${aws_athena_database.hoge.name}", "--result-configuration", "OutputLocation=s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/movie/" ]
      }
    }
step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        #aws athena start-query-execution --query-string "select * from tbl01;" --result-configuration "OutputLocation=s3://ruan-athena-bucket/output/"     
        args = ["aws", "athena", "start-query-execution", "--query-string", "${aws_athena_named_query.six.query}", "--query-execution-context", "Database=${aws_athena_database.hoge.name}", "--result-configuration", "OutputLocation=s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/movie/" ]
      }
    }
step {
      ...
      hadoop_jar_step {
        jar  = "command-runner.jar"
        #aws athena start-query-execution --query-string "select * from tbl01;" --result-configuration "OutputLocation=s3://ruan-athena-bucket/output/"     
        args = ["aws", "athena", "start-query-execution", "--query-string", "${aws_athena_named_query.seven.query}", "--query-execution-context", "Database=${aws_athena_database.hoge.name}", "--result-configuration", "OutputLocation=s3://${aws_s3_bucket.bucketbigdataemrsimoo.bucket}/files/movie/" ]
      }
    }
...
resource "aws_s3_bucket_object" "bucketbigdataemrsimoo" {
