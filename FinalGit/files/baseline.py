...
ratings_data_temp=sc.textFile("s3://bucketbigdataemrsimoo/files/ratings.csv",n_partitions)
...
# Creo l'RDD dal file csv identificato tramite il percorso contenuto in S3 specificando anche il n° di partizioni
#in cui l'RDD verrà splittato
movie_data_temp = sc.textFile("s3://bucketbigdataemrsimoo/files/movies.csv", n_partitions)
